...
* Modified by SDN 26/9/2012 to fix the bug in  readChar
* Modified by SDN 21/8/2013 to make readBoolean deal with Y/N and reject improper input
* Modified by SDN 11/9/2021 to include readLong
*/
...
public class EasyReader extends BufferedReader {
	...
	*/
	public long readLong() {
		long x = 0;
		try {
			x=(new Long(readString())).longValue();
		}
		catch (Exception e) {
			error("invalid long number");
		}
		return x;
	}

	/**
	* Read an long from the input stream, with a prompt
	* @param s	String 	The prompt
	* @return long 		the long value
	*/
